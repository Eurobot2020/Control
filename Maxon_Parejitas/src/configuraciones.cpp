...
{
	mecanica->reductora = 26 * 26 / 39; //SinPosa = 25 //Parejitas = 26 * 26 / 39
	mecanica->diametro = 5.23;  //SinPosa = 5.45 //Parejitas = 5.23
	mecanica->vel_eje_max = 8100 / mecanica->reductora;																										//	6380;
	mecanica->vel_max = mecanica->vel_eje_max * PI / 30;
	mecanica->pulsos_por_rev = 256;
	mecanica->L = 24.8;	//SinPosa = 9.8 //Parejitas = 24.8
	...
	//de velocidad	
	mecanica->aceleracion = 4000;		//SinPosa = 4000 //Parejitas = 1000
	mecanica->deceleracion = 4000;		//SinPosa = 4000 //Parejitas = 1000								//( -0.59*pow(variable->velocidad_final,3) + 5.4*pow(variable->velocidad_final,2) - 14*variable->velocidad_final + 17)*(mecanica->reductora)*(1/(2*PI))*60;
}
