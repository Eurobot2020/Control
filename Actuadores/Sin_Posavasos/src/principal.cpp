...
#define UP_V      A0       //Abort
#define DOWN_V    A1       //Hold         ROJO SIN CONECTAR DA IGUAL EL SENTIDO
#define UP_H      A2       //Resume
...
ISR(TIMER0_COMPA_vect){    //This is the interrupt request
  ...
  if(pwm >= 11){               // mayor número = menor velocidad (NÚMERO ESTÁNDAR 11 Ó 12)                     
